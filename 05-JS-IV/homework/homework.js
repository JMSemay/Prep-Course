...
function nuevoUsuario (nombre, email, password) {
  ...
  let objeto = {
    nombre: nombre,
    email: email,
    password,// js entiende que si el nombre del parametro de la funcion lleva el mismo nombre que el nombre de la propiedad del objeto va a tener el mismo valor
  }
  return objeto;
  }
